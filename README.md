📣 Vous trouverez [ici](https://github.com/arolla/first-react-app-tutorial/wiki/Commentaires) les commentaires de ceux qui ont déjà fait le tuto (en attendant leur intégration au tuto)
